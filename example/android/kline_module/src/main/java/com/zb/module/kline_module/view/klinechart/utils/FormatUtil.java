...
public class FormatUtil {
    ...
    public static String parseDoubleMax8(double number) {
        ...
        return BigDecimal.valueOf(FormatUtil.parseDouble(sDecimalFormat.format(number))).stripTrailingZeros().toPlainString();
    }
    ...
    public static String parseDoubleMax8(String number) {
        ...
        sDecimalFormat.setDecimalFormatSymbols(symbols);
        sDecimalFormat.applyPattern("#.00000000");
        return BigDecimal.valueOf(FormatUtil.parseDouble(sDecimalFormat.format(parseDouble(number)))).stripTrailingZeros().toPlainString();
    }
...
//        Log.i("parseDoubleMax3_1",System.currentTimeMillis()+"");
        ...
        sDecimalFormat.setDecimalFormatSymbols(symbols);
        sDecimalFormat.applyPattern("#.000");
        String s = BigDecimal.valueOf(FormatUtil.parseDouble(sDecimalFormat.format(parseDouble(number)))).stripTrailingZeros().toPlainString();
//        Log.i("parseDoubleMax3_2",System.currentTimeMillis()+"");
    ...
    public static String parseDoubleMax_X(String number, int x) {
        ...
        BigDecimal value = BigDecimal.valueOf(FormatUtil.parseDouble(sDecimalFormat.format(parseDouble(number))));
    ...
    public static String parseDoubleMax_X(double number, int x) {
        ...
        BigDecimal value = BigDecimal.valueOf(FormatUtil.parseDouble(sDecimalFormat.format(number)));
        if(value.compareTo(BigDecimal.ZERO) != 0){
            return value.stripTrailingZeros().toPlainString();
        }else{
            value = BigDecimal.ZERO;
    ...
    public static String conversionPercentage(double number, int digit) {
        ...
        nf.setMaximumFractionDigits(digit);//这个1的意识是保存结果到百分比小数点后几位，但是特别声明：这个结果已经先＊100了。
