...
import com.zb.module.kline_module.view.klinechart.draw.KDJDraw;
...
import com.zb.module.kline_module.view.klinechart.draw.RSIDraw;
import com.zb.module.kline_module.view.klinechart.draw.VolumeDraw;
import com.zb.module.kline_module.view.klinechart.draw.WRDraw;
import com.zb.module.kline_module.view.klinechart.loading.LoadingFrameLayout;
...
//        setScrollX((int) (0-((getOverScrollRange()/getScaleX()))));
    ...
    public com.zb.module.kline_module.view.klinechart.adapter.KLineChartAdapter getKLineChartAdapter() {
